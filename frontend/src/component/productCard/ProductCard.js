  ...
  return (
      <div className={'card'}>
        <div className={'card__img-wrapper'}>
          <img className={'card__img'} src={productImg} alt="product"/>
        ...
        <div className={'card__content'}>
          <div className={'card__stars'}>
            <ProductStarRating starsNumber={4.5}/>
          </div>
