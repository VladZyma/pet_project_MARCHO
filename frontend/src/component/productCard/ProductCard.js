          ...
          }
          {
            !isGrid
                ...
                <div className={'card__links'}>
                  ...
                  <button className={'card__link card__link--btn'} onClick={() => setShowSizePopUp(true)}>
        ...
        </div>
        {
          !isGrid
              ...
              <div className={'card__content'}>
                ...
                <button className={'card__content-button'} onClick={() => setShowSizePopUpGrid(true)}>Add to cart</button>
                {
                  showSizePopUpGrid
                    &&
                    <ProductSizePopUp
