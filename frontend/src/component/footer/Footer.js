            ...
            <div className={'container'}>
                <div className={'footer__top'}>
                    <div className={'footer__top-item footer__top-item--contacts'}>
                        ...
                        <Link className={'footer__top-email'} href="mailto:Youremail@gmail.com">Youremail@gmail.com</Link>
                        <Link className={'footer__top-phone'} href="tel:+02838388393">+0283 838 8393</Link>
                        <ul className={'footer__top-social-list'}>
                            <li className={'footer__top-social-item'}>
                                <Link className={'footer__top-social-link'} href="#">
                    ...
                    <div className={'footer__top-item footer__top-item--links'}>
                        ...
                        <ul className={'footer__top-info-list'}>
                            <li className={'footer__top-info-item'}>
                                <Link className={'footer__top-link'} href={'#'}>
                                    About Us
                                </Link>
                            </li>
                            <li className={'footer__top-info-item'}>
